    ...
    return(
        ...
        <div className="row top-buffer text-center align-items-center h-100" >
            ...
            <div className="col-12 col-md-6">
                ...
                <button className="btn btn-outline-light btn-lg mt-3 mb-2"> Restaurants </button>
                </div>  
                <div className="col-12 col-md-6 text-lg-left text-center">
                <button className="btn btn-outline-light btn-lg mt-3 mb-2"> Notes </button>
                </div> 
                </div>
            </div>
        </div>
